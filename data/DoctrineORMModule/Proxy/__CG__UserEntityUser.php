...
class User extends \User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'User\\Entity\\User' . "\0" . 'id', '' . "\0" . 'User\\Entity\\User' . "\0" . 'nome', '' . "\0" . 'User\\Entity\\User' . "\0" . 'email', '' . "\0" . 'User\\Entity\\User' . "\0" . 'password', '' . "\0" . 'User\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'User\\Entity\\User' . "\0" . 'phone', '' . "\0" . 'User\\Entity\\User' . "\0" . 'city', '' . "\0" . 'User\\Entity\\User' . "\0" . 'uf', '' . "\0" . 'User\\Entity\\User' . "\0" . 'cpf', '' . "\0" . 'User\\Entity\\User' . "\0" . 'address', '' . "\0" . 'User\\Entity\\User' . "\0" . 'type', '' . "\0" . 'User\\Entity\\User' . "\0" . 'department', '' . "\0" . 'User\\Entity\\User' . "\0" . 'status');
        }
